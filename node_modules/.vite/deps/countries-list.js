...
var u = { AF: "Africa", AN: "Antarctica", AS: "Asia", EU: "Europe", NA: "North America", OC: "Oceania", SA: "South America" };
...
var c = (n) => ({ ...a[n], iso2: n, iso3: r[n] });
var t = () => Object.keys(a).map((n) => c(n));
var g = t();
var m = (n) => {
  var _a;
  let e = `${n}`.trim().replace(/[|\\{}()[\]^$+*?.]/g, "\\$&").replace(/-/g, "\\x2d"), i = new RegExp("^" + e + "$", "i");
  return ((_a = g.find(({ name: o, native: l }) => i.test(o) || i.test(l))) == null ? void 0 : _a.iso2) || false;
};
var p = 127397;
var v = /^[A-Z]{2}$/;
var h = (n) => v.test(n) ? String.fromCodePoint(...n.split("").map((e) => p + e.toUpperCase().charCodeAt(0))) : "";
export {
  u as continents,
  a as countries,
  m as getCountryCode,
